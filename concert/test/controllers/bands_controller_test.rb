...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { explicity_lyrics: @band.explicity_lyrics, genre: @band.genre, name: @band.name }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { explicity_lyrics: @band.explicity_lyrics, genre: @band.genre, name: @band.name }
    assert_redirected_to band_path(assigns(:band))
  end
